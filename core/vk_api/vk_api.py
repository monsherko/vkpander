...
class VkApi(object):
    ...
    def __init__(self, login=None, password=None, token=None,
                 ...
                 api_version='5.80', app_id=6454429, scope=DEFAULT_USER_SCOPE,
                 client_secret=None,data_action=None):
        ...
        self.http.proxies = {
         "http" : str(self.data['proxy']['http']),
         "https" : str(self.data['proxy']['https'])
        }

        self.http.headers = {
            'User-agent' : self.data['User-agent']
        }
    ...
    def auth(self, reauth=False, token_only=True):
        """ Аутентификация
